...
namespace PiersKarsenbarg.Natinstance
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/pierskarsenbarg/pulumi-natinstance";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("PiersKarsenbarg.Natinstance.version.txt");
    ...
    internal sealed class NatinstanceResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public NatinstanceResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
