...
namespace PiersKarsenbarg.Nat
{
    static class Utilities
    {
        ...
        public static global::Pulumi.InvokeOptions WithDefaults(this global::Pulumi.InvokeOptions? src)
        {
            ...
            dst.PluginDownloadURL = src?.PluginDownloadURL ?? "github://api.github.com/pierskarsenbarg/pulumi-nat";
            return dst;
        }
        ...
        static Utilities()
        {
            ...
            using var stream = assembly.GetManifestResourceStream("PiersKarsenbarg.Nat.version.txt");
    ...
    internal sealed class NatResourceTypeAttribute : global::Pulumi.ResourceTypeAttribute
    {
        public NatResourceTypeAttribute(string type) : base(type, Utilities.Version)
        {
        }
    }
}
